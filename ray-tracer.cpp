...
int main(int argc, char** argv)
{
  ...
  addBubble( scene, Point3( -10, 2, -1 ), 1.0, Material::glass() );
  addBubble( scene, Point3( 5, 1, -1 ), 3.0, Material::glass() );
  addBubble( scene, Point3( -5, 3, 5 ), 2.0, Material::glass() );
  addBubble( scene, Point3( 5, 1, 12 ), 1.0, Material::glass() );
  addBubble( scene, Point3( -6, 4, -1 ), 2.0, Material::glass() );
